      ...
      <div class="container">
            ...
            <center>
                  ...
                  ?>
                        ...
                        <input type='num' class="form-control" name='id' value="<?php echo $form_data['id'] ?>" hidden></br>
                        <label>date</label>
                        <input type='date' class="form-control" name='date' value="<?php echo $form_data['date'] ?>"></br>
                        <label>client_num</label>
                        <input type='text' class="form-control " name='client_num' placeholder="client_num" value="<?php echo $form_data['client_num'] ?>"></br>
                        <label>issue_num</label>
                        <input type='text' class="form-control " name='issue_num' placeholder="issue_num" value="<?php echo $form_data['issue_num'] ?>"></br>
                        ...
                        <input type='text' class="form-control " name='issue_kind' placeholder="issue_kind" value="<?php echo $form_data['issue_kind'] ?>"></br>
                        <label>place</label>
                        <input type='text' class="form-control " name='place' placeholder="place" value="<?php echo $form_data['place'] ?>"></br>
                        <label>start_time</label>
                        <input type='time' class="form-control " name='start_time' placeholder="start_time" value="<?php echo $form_data['start_time'] ?>"></br>
                        ...
                        <textarea class="form-control" name="activity_text" cols="40" rows="5"><?php echo $form_data['activity_text'] ?></textarea>
                        <label>checking_text</label>
                        <textarea class="form-control" name="checking_text" cols="40" rows="5"><?php echo $form_data['checking_text'] ?></textarea>
                        <label>summary_text</label>
                        <textarea class="form-control" name="summary_text" cols="40" rows="5"><?php echo $form_data['summary_text'] ?></textarea>
                        <label>remarks_text</label>
                        <textarea class="form-control" name="remarks_text" cols="40" rows="5"><?php echo $form_data['remarks_text'] ?></textarea>
